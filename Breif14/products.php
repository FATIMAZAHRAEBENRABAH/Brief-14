    ...
    ?>
        <div class="col-sm-3">
            <form id="myform" action="" method="post" enctype=" multipart/form-data">
                ...
                <a href="details.php?productId=<?php echo $finalResult['idProduit'];?>">
                <img class="prodImg" src="<?php echo $finalResult['image']; ?>" alt="">
                <div class="content <?php echo ($finalResult['stock'] == 0)? 'text-danger' : '';?>"> </a>
                ...
                <?php if($finalResult['stock'] > 0){?>
                    <input class="form-control mt-2" name="quantite" type="number" value="1" min="1" max="10" step="1" />
