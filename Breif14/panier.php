                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card ">
                                        <div class="card-body">
                                            ...
                                            foreach($_SESSION['panier'] as $produit){
                                                $subtotal = $produit['produit_prix'] * $produit['produit_quantite'];
                                                $total += $subtotal;
                                                ?>
                                                ...
                                                <div class="d-flex flex-row align-items-center">
                                                    ...
                                                    <div style="width: 80px;">
                                                        <h5 class="mb-0">$<?php echo $subtotal?></h5>
                                                    </div>
                             ...
                             <div class="total d-flex justify-content-end mt-4">
                                <p class="total_panier">Total : <span>$<?php echo $total?></span></p>
                            </div>
