                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="carousel-caption ">
                                ...
                                <p class="pA">Ready to go for that everyday glow</p>
                                <a href="" class="pA">SHOP SERUMS</a>
                            </div>
                        </div>
                        <div class="carousel-item">
                        ...
                        <div class="col">
                            <div class="mg13">
                                ...
                                <div class="card-bod">
                                    ...
                                    <p class="para">We only use the finest  natural ingredients.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="">
                                ...
                                <p class="para">Orders are shipped with biodegradable peanuts.</p>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="">
                                <h6 class="vegan" class="card-title">Vegan</h6>
                                <p class="para">Our entire collection is vegan and cruelty free.</p>
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="">
                                <h6 class="vegan" class="card-title">Vegan</h6>
                                <p class="para">All packaging is recyclable and eco conscious.</p>
                            </div>
                        </div>
                       </div>
                       <div class="Herbivore">
